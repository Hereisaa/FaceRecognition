...
def CatchPICFromVideo(window_name, camera_idx, catch_pic_num, path_name):
    ...
    #告訴OpenCV使用人臉識別分類器
    classfier = cv2.CascadeClassifier("C:\\Users\\user\\AppData\\Local\\Programs\\Python\\Python37\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_alt2.xml")
...
if __name__ == '__main__':
    if len(sys.argv) != 1:
        ...
        CatchPICFromVideo("擷取人臉", 0, 1000, 'C:\\Users\\user\\Documents\\GitHub\\FaceRecognition\\data\\aaron')
