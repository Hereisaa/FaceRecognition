...
def load_dataset(path_name):
    ...
    #標註資料，'aaron'資料夾下都是我的臉部影象，全部指定為0，另外一個資料夾下是同學的，全部指定為1
    labels = np.array([0 if label.endswith('chiawei') else 1 for label in labels])    
...
if __name__ == '__main__':
    if len(sys.argv) != 1:
        ...
        images, labels = load_dataset("C:\\Users\\user\\Documents\\GitHub\\FaceRecognition\\data")